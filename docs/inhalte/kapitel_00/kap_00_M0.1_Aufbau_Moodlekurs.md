...
- Innerhalb eines Kapitels finden Sie Arbeitsaufträge, Informationsmaterialien und vieles mehr. Diese Aktivitäten haben eine im Kapitel fortlaufende Nummer, sodass jede Aktivität direkt angesprochen werden kann.
  ...
  - **Abgaben:** Die Abgaben in den Aufgaben werden für die Mitarbeitsbewertung herangezogen. Es können je nach Aufgabe Einzel- oder Gruppenergebnisse abgegeben werden. Eine Abgabe sollte zeitnah zu der Unterrichtsstunde stattfinden und kann damit ggf. auch am Nachmittag nach Fertigstellung oder Überarbeitung von Aufgaben erfolgen.
